...
formattedData.forEach((racer) => {
  racingCards += `
           ...
           <div class="general-info line">
             <div class="rank" >${racer.number}</div>
             <button class="btn" id="increment-score"> 
             +
            </button>
             <div class="points">
           ...
           <div class="pilot-info line">
             <div class="name">
               <div class="vertical-line" style="background-color: ${racer.hex}"></div>
           ...
           <div class="driver-info">
             ...
             <img
               class="driver-number"
               src="https://www.formula1.com/content/dam/fom-website/2018-redesign-assets/drivers/number-logos/MAXVER01.png.transform/2col/image.png"
             />
           </div>
         </div>
       `;
